...
@media (min-width: 901px) {
  ...
  /* Overview: 12-col layout — music beside weather, compact nebula beside env */
  .sc-grid.ov { grid-template-columns: repeat(12, 1fr); align-items: stretch; }
  .sc-grid.ov .sc-row.quick { grid-column: 1 / -1; }
  .sc-grid.ov .sc-col.hero { grid-column: span 7; }
  .sc-grid.ov .sc-row.weather { grid-column: span 5; }
  .sc-grid.ov .sc-ov-nebula { grid-column: span 7; min-width: 0; display: flex; }
  .sc-grid.ov .sc-ov-nebula > .sc-full { flex: 1; }
  .sc-grid.ov .sc-row.env { grid-column: span 5; }
  .sc-grid.ov .sc-row.mantra { grid-column: 1 / -1; }
}
