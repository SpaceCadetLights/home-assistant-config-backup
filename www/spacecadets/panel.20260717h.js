      ...
      <main class="sc-main">
        <header class="sc-top">
          <div class="sc-top-row sc-top-greet-row">
            ...
            <div class="sc-menu-spacer" aria-hidden="true"></div>
          </div>
      ...
      <div class="sc-full glass sc-nebula ${on ? "live" : ""}">
        ...
        <div class="sc-nebula-inner">
          ...
          <div class="sc-nebula-grid">
            <label class="sc-nebula-field wide">
              <span class="sc-nebula-lbl">EFFECT</span>
              <div class="sc-nebula-selwrap">
                <select class="sc-select nebula" data-act="effect" data-entity="${light}" ${effects.length ? "" : "disabled"}>
                  ${effects
                    .map((e) => `<option ${e === curEffect ? "selected" : ""} value="${this._esc(e)}">${this._esc(e)}</option>`)
                    .join("")}
                </select>
              </div>
            </label>
            ...
            <label class="sc-nebula-field wide">
              <span class="sc-nebula-lbl">PALETTE</span>
              <div class="sc-nebula-selwrap">
                <select class="sc-select nebula" data-act="select" data-entity="${paletteEnt}" ${palettes.length ? "" : "disabled"}>
                  ${palettes
                    .map((o) => `<option ${o === curPalette ? "selected" : ""} value="${this._esc(o)}">${this._esc(o)}</option>`)
                    .join("")}
                </select>
              </div>
            </label>
...
@media (max-width: 900px) {
  ...
  .sc-col.hero { aspect-ratio: 16 / 10; min-height: 190px; max-height: 240px; }
