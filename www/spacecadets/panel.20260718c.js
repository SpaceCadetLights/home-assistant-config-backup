...
/* Phones/small tablets: force every overview block full width, single column
   and centered (no leftover half-width columns). */
@media (max-width: 1023px) {
  .sc-grid.ov { grid-template-columns: 1fr; }
  .sc-grid.ov > .sc-col.hero,
  .sc-grid.ov > .sc-ov-nebula,
  .sc-grid.ov > .sc-row { grid-column: 1 / -1; width: 100%; justify-self: stretch; margin-inline: 0; }
}
